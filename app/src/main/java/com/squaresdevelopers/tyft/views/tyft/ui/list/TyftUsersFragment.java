...
import com.squaresdevelopers.tyft.viewModels.TyftUserViewModel;

import java.util.List;


public class TyftUsersFragment extends Fragment {

    TyftUserViewModel userViewModel;
